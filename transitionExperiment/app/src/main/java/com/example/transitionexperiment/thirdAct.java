...
public class thirdAct extends AppCompatActivity {
    ...
    public void fadeActivity(View view){
        startActivity(new Intent(thirdAct.this,thirdAct.class));
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
    }

    public void explodeActivity(View view){
        ActivityOptions options= ActivityOptions.makeSceneTransitionAnimation(this);
        startActivity(new Intent(thirdAct.this,thirdAct.class), options.toBundle());
    }
    ...
    public void sharedTransmition(View view){
        ...
        startActivity(new Intent(thirdAct.this,frthAct.class), options.toBundle());
    }
}